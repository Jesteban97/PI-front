...
const ELEMENT_DATA: Usuario[] = [
  //{ idUsuario: 1, nombreCompleto: "jose mendez", correo: "jose@gmail.com", idRol: 1,rolDescripcion:"Administrador",clave:"1233"},
  //{ idUsuario: 2, nombreCompleto: "leo muñoz", correo: "leo@gmail.com", idRol: 2, rolDescripcion: "Empleado",clave:"4566"},
  //{ idUsuario: 3, nombreCompleto: "yamile pinto", correo: "yamile@gmail.com", idRol: 2, rolDescripcion: "Empleado",clave:"6788"},
...
export class UsuariosComponent implements OnInit, AfterViewInit {
  displayedColumns: string[] = ['nombreCompleto', 'correo', 'rolDescripcion','acciones'];
